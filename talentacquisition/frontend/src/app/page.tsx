...
export default function HomePage() {
    ...
    const features = [
        {
            ...
            description:
                'Machine learning algorithms analyze resumes in seconds, saving 70% of screening time',
            stats: '70% faster',
        ...
        },
        {
            ...
            description:
                'WebRTC-powered interviews with screen sharing, recording, and real-time collaboration',
            stats: 'Real-time',
        ...
        },
        {
            ...
            description:
                'Gamified onboarding experience with AI mentor and personalized learning paths',
            stats: '90% completion',
    ...
    useEffect(() => {
        if (isHeroVisible) {
            announce(
                'Welcome to HireRoyale - Revolutionizing talent acquisition and onboarding'
            );
        }
            ...
            >
                <div className=' flex flex-col items-center justify-center mx-auto text-center'>
                    ...
                    >
                        ...
                        >
                            AI-powered hiring and onboarding platform designed
                            for modern enterprises. Faster hiring, better
                            candidates, seamless onboarding experience.
                        </motion.p>
                ...
                <div className='max-w-7xl mx-auto'>
                    ...
                    >
                        ...
                        <p className='text-lg sm:text-xl text-blue-100 max-w-2xl mx-auto'>
                            Cutting-edge technologies powering the future of
                            recruitment
                        </p>
                    </motion.div>
                ...
                <div className='max-w-7xl mx-auto'>
                    ...
                    >
                        ...
                        <p className='text-lg sm:text-xl text-blue-100 max-w-3xl mx-auto'>
                            Built with cutting-edge technology to solve real
                            hiring challenges
                        </p>
                    </motion.div>
                            ...
                            >
                                <Card className='bg-white/95 backdrop-blur shadow-2xl border-0 h-full overflow-hidden group-hover:shadow-3xl transition-all duration-500'>
                                    <CardBody className='p-6 sm:p-8 text-center relative'>
                                        ...
                                        />
                                        <div
                                            className={`p-4 rounded-2xl bg-gradient-to-r ${feature.color} w-20 h-20 mx-auto mb-6 flex items-center justify-center text-white shadow-lg group-hover:shadow-xl transition-all duration-300`}
                                        >
                                            {feature.icon}
                                        </div>
                                        ...
                                        <Badge
                                            className={`bg-gradient-to-r ${feature.color} text-white text-sm font-medium px-3 py-1`}
                                        >
                                            {feature.stats}
                                        </Badge>
                                    </CardBody>
                ...
                <div className='max-w-4xl mx-auto text-center'>
                    ...
                    >
                        ...
                        <p className='text-lg sm:text-xl text-blue-100 mb-8 max-w-2xl mx-auto'>
                            Join the revolution in talent acquisition and
                            onboarding
                        </p>
            ...
            <footer className='py-12 px-4 sm:px-6 lg:px-8 border-t border-white/10'>
                <div className='max-w-7xl mx-auto text-center'>
                    ...
                    <p className='text-blue-100 mb-6 max-w-2xl mx-auto'>
                        Revolutionizing talent acquisition and onboarding for
